const Jobs = () => {
  return (
    <div className="h-[90dvh]">
      <div className="hero md:bg-[url('/src/assets/interview-banner.jpg')] h-[50%] flex items-center">
      ...
      <div className="flex items-center justify-center pt-4">
        <div className="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
          ...
          <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
            At least 1- 5 years of end-to-end web – application/tool development
            experience in a commercial setup specifically services.
          </p>
          <a
            href={`/job`}
